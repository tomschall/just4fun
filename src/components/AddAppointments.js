...
class AddAppointments extends Component {
	...
	handleAdd(e){
		...
		let tempApt = {
			...
			ownerName: this.state.owonerName,
	...
	render() {
		return (
			<div className={'card textcenter mt-3 ' + (this.props.formDisplay ? '' : 'add-appointment')}>
				...
				>
					<FaPlus /> Termin vereinbaren
				</div>

				<div className="card-body">
					<form id="aptForm" noValidate onSubmit={this.handleChange}>
						<div className="form-group form-row">
							<label className="col-md-2 col-form-label text-md-right" htmlFor="petName" readOnly>
								Name / Institution
							</label>
							<div className="col-md-10">
								<input type="text" className="form-control" name="petName" placeholder="Name / Institution"
						...
						<div className="form-group form-row">
							<label className="col-md-2 col-form-label text-md-right" placeholder="E-mail">
								E-Mail
							</label>
							<div className="col-md-10">
								<input
